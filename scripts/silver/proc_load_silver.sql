/*
===============================================================================
Stored Procedure: Load Silver Layer (Bronze:DB -> Silver: DB)
===============================================================================
Script Purpose:
...
BEGIN
	-- Khai báo biến tính thời gian thực thi
    DECLARE
    ...
    BEGIN TRY
		...
		-- Tải thông tin địa điểm (location) thêm của khách hàng 
		...
		-- Tải thông tin phân loại (category) của sản phẩm 
		...
		PRINT '=========================================='
	END TRY
	-- Xử lí lỗi khi thực thi thủ tục 
	BEGIN CATCH
		PRINT '=========================================='
